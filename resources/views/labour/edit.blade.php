                            ...
                            <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                              <select class="form-control select_branch form-select" name="vehicleType">
                                ...
                                @if (!empty($body_type))
                                    ...
                                    <option value="{{ $body_types->vehicle_type }}" {{ $body_types->vehicle_type == $o_type_point->vehicleType ? 'selected' : '' }}>
                        ...
                        <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                          ...
                          <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                              <select class="form-control select_branch form-select" name="modelName">
                                ...
                                <option value="{{ $model_names->model_name }}" {{ $model_names->model_name == $o_type_point->modelName ? 'selected' : '' }}>
                      ...
                      <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                          ...
                          <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                              <select class="form-control select_branch form-select" name="name">
                                  ...
                                  <option value="{{ $libraries->name }}" {{ $libraries->name == $o_type_point->name ? 'selected' : '' }}>
                                      {{ $libraries->name }}
                                  </option>
                                  @endforeach
                                  @endif
