          ...
          <div class="row mt-3">
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
              ...
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date">
                <input type="date" name="Date" autocomplete="off" id="date_of_birth" class="form-control invoiceDate datepicker" placeholder="yyyy-mm-dd" onkeypress="return false;" required="" value="{{ date('Y-m-d') }}">
              </div>
            </div>
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
