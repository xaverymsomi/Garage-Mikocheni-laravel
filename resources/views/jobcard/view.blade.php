                                    ...
                                    <table class="table table-bordered adddatatable" id="tab_taxes_detail" align="center" style="font-size:14px;" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr id="row_id_{{ $row_id }}">
                                            <td class="tbl_td_selectManufac_error_{{ $row_id }}">
                                                @php
                                                    $selectedManufactureName = '';
                                                    foreach ($manufacture_name as $manufacture_nm) {
                                                        if ($manufacture_nm->id == $stocks->product_type_id) {
                                                            $selectedManufactureName = $manufacture_nm->type;
                                                            break;
                                                        }
                                                    }
                                                @endphp
                                            ...
                                            <td class="tbl_td_selectProductname_error_{{ $row_id }}">
                                                @php
                                                    $selectedProductName = '';
                                                    foreach ($brand as $brands) {
                                                        if ($brands->id == $stocks->product_id) {
                                                            $selectedProductName = $brands->name;
                                                            break;
                                                        }
                                                    }
                                                @endphp
                                            ...
                                            <td class="tbl_td_quantity_error_{{ $row_id }}">
                                                {{ $stocks->quantity }}
                                            </td>
                                        </tr>
                                        <?php $row_id++; ?>
