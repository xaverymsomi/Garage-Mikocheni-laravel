          ...
          <form id="productAdd-Form" method="post" action="{{ url('/product/store') }}" enctype="multipart/form-data" class="form-horizontal upperform productAddForm">
            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  ...
                  <input type="text" id="part_no" name="part_no" class="form-control" value="{{ old('part_no') }}" placeholder="{{ trans('Enter Part No') }}">
                </div>
              </div>
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  ...
                  <input type="text" id="auto_maker_parts_no" name="auto_maker_parts_no" class="form-control" value="{{ old('auto_maker_parts_no') }}" placeholder="{{ trans('Auto Maker Part No') }}">
                </div>
              </div>
            </div>
            ...
            <div class="row row-mb-0">
              ...
              <div class="row row-mb-0">
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="first-name">{{ trans('Model Application') }} <label class="color-danger">*</label></label>
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">

                  <input type="text" id="model_application" name="model_application" class="form-control" value="{{ old('model_application') }}" placeholder="{{ trans('Model Application No') }}">
                </div>
              </div>
