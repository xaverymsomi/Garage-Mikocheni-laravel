    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <table class="table table-bordered adddatatable"
          ...
          <tbody>
            <tr>
              ...
              <td class="cname text-center"><?php if (!empty($s_date)) {
        ...
        <table class="table table-bordered"
          ...
          <tr>
            <td class="text-right cname"
              width="81.5%"><b>{{ trans('message.Total Service Amount') }} (<?php echo getCurrencySymbols(); ?>) :</b></td>
          ...
          <tr>
            <td class="text-right cname"
              width="81.5%"><b>{{ trans('message.Discount') }} (<?php echo $dis = $service_tax->discount . '%'; ?>):</b></td>
          ...
          <tr>
            <td class="text-right cname"
              width="81.5%"><b>{{ trans('message.Total') }} (<?php echo getCurrencySymbols(); ?>) :</b></td>
          ...
          <tr>
            <td class="text-right cname"
              width="81.5%"><b><?php echo $ser_tax; ?> :</b></td>
            <td class="text-center cname"
              width="81.5%"><b><?php $all_taxes;
          ...
          <tr>
            <td class="text-right cname"
              width="81.5%"><b>{{ trans('message.Grand Total') }} (<?php echo getCurrencySymbols(); ?>) :</b></td>
...
<div class="modal-footer">
  ...
  <button type="button"
    class="btn btn-outline-secondary printbtn"
    id=""
    onclick="PrintElem('sales_print')">{{ trans('message.Print') }} </button>
<button type="button"
      class="btn btn-outline-secondary prints" data-bs-dismiss="modal">{{ trans('message.Close') }}</button>
</div>
