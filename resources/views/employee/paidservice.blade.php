...
<div>
  <div id="sales_print">
    ...
    <div class="row">
      <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 ps-1">
        <!-- <h3><?php echo $logo->system_name; ?></h3> -->
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <table class="table adddatatable paid_service" width="100%" border="0" style="border-collapse:collapse;">
            ...
            <tbody>
              <tr>
                ...
                <td class="cname text-left fw-bold"><?php echo getVehicleName($job->vehicle_id); ?></td>
          ...
          <table class="table table-bordered" width="100%" style="border-collapse:collapse;">
            ...
            <tr>
              <td class="text-end cname" >{{ trans('message.Discount') }} (<?php echo $dis = $service_tax->discount . '%'; ?>):</td>
            ...
            <tr>
              ...
              <td class="text-left cname fw-bold gst"><?php $after_dis_total = $total_amt - $discount;
            ...
            <tr>
              ...
              <td class="text-left cname fw-bold gst"><?php $service_tax;
                echo number_format($service_tax, 2); ?></td>
            </tr>
            <?php 
							}
  ...
  <!-- <div class="modal-footer">
      ...
      <button type="button" class="btn btn-outline-secondary printbtn"
      id=""
