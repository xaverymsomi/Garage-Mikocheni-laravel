...
<div class="right_col" role="main">
   ...
   <div class="row">
      <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12">
         <div class="x_panel">
            <div class="x_content">
               <form id="companyvehicleAdd-Form" action="{{ url('/company_vehicle/store') }}" method="post" enctype="multipart/form-data" class="form-horizontal upperform vehicleAddForm">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="row row-mb-0">
                     <div class="row row-mb-0">
                        <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                           <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="first-name">{{ trans('Added By')}}<label class="color-danger"></label></label>
                           <div class="form-group col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 mb-0 pt-2">
                              <input class="form-control" type="text" name="added_by" value="{{ Auth::user()->name }}" readonly>
                  ...
                  <div class="row row-mb-0">
                    <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                       <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="first-name">{{ trans('Vehicle Conditions') }} <label class="color-danger"></label></label>
                       <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                        <div class="select-wrapper">
                            <select class="form-control select_branch form-select" name="conditions">
                              
                                <option value="">--- Select Vehicle Conditions ---</option>
                  ...
                  <div class="row row-mb-0">
                    <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                       <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="last-name">{{ trans('Vehicle Transmission') }} <label class="color-danger">*</label></label>
                       <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                        <div class="select-wrapper">
                            <select class="form-control select_branch form-select" name="transmission">
                              
                                <option value="">--- Select Vehicle Transmission ---</option>
                                <option value="automatic">Automatic Vehicles</option>
                                <option value="manual">Manual Vehicles</option>
                             </select>
                        </div>
                     </div>
                    </div>
                    <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                       <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="first-name">{{ trans('Vehicle Warranty') }} <label class="color-danger"></label></label>
                       <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                        <div class="select-wrapper">
                            <input type="text" name="Warranty" value="" class="form-control" placeholder="{{ trans('Enter Vehicle Warranty') }}">
                        </div>
                     </div>
                    </div>
                 </div>
                  ...
                  <div class="row row-mb-0">
                     ...
                     <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                        <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="last-name">
                            {{ trans('Quantity') }}  <label class="color-danger">*</label>
                            </label>
                            <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                               <input type="number" name="quantity" value="" class="form-control" maxlength="10">
                            </div>
                         </div>
                  </div>
                  <div class="row row-mb-0">
...
<script>
   ...
   $(document).ready(function() {
       ...
       $('body').on('click', '.vehicleAddSubmitButton', function(e) {
           $('#companyvehicleAdd-Form input, #companyvehicleAdd-Form select, #companyvehicleAdd-Form textarea').each(
       ...
       // added by arjun for module dynamic add item and reove item
...
{!! JsValidator::formRequest('App\Http\Requests\CompanyVehicleAddEditFormRequest', '#companyvehicleAdd-Form') !!}
