          ...
          <table id="supplier" class="table jambo_table" style="width:100%">
            ...
            <tbody>
              ...
              @endcan
                ...
                <td><a href="{!! url('/vehicle/list/view/' . $vehicals->id) !!}">{{ $vehicals->modelname }}</a>
                  <!-- <a data-toggle="tooltip" data-placement="bottom" title="Model Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a> -->
                </td>
                <td>{{ getVehicleType($vehicals->vehicletype_id) }} 
