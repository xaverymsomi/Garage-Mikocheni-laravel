    ...
    <div class="">
      ...
      <div class="x_content">
        <ul class="nav nav-tabs bar_tabs"
          ...
          <li role="presentation"
            class="active"><a href="{!! url('/observation_type/add') !!}"><span class="visible-xs"></span> <i
                class="fa fa-plus-circle fa-lg">&nbsp;</i><b>{{ trans('message.Add Observation Type') }}</b></span></a></li>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <form method="post"
                action="{!! url('observation_type/store') !!}"
