            ...
            <div class="x_panel mb-0">
                <div class="x_content">
                    <form id="QuotationEdit-Form" method="post" action="update/{{ $service->id }}" enctype="multipart/form-data" class="form-horizontal upperform">
                        ...
                        <div class="row row-mb-0">
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 row-mb-0">
                              <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="first-name">{{ trans('Insurer Name') }} </label>
                              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                <input type="text" id="" name="insurer" class="form-control fixServiceCharge" placeholder="{{ trans('Enter Insurer Name') }}" value="{{ $service->insurer_name }}">
                                  
                              </div>
                          </div>
  
                          <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 row-mb-0">
                            <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="first-name">{{ trans('Broker Name') }} </label>
                            <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                              <input type="text" id="" name="broker" class="form-control fixServiceCharge" placeholder="{{ trans('Enter Broker Name') }}" value="{{ $service->broker_name }}">
