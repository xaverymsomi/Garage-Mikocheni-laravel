                ...
                <table class="table table-bordered" width="100%" border="1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="cname text-center"><?php 
...
echo $vehical->registration_no;
            ...
            if (!empty($service_pro))
              ...
              ?>
                        <tr>
                            <td class="cname text-center" colspan="7">{{ trans('message.No data available in table.') }}
                            </td>
                        </tr>
                        <?php
            }
            ...
            if(!empty($service_pro2)) {
              ...
              ?>
                        <tr>
                            <td class="cname text-center" colspan="6">
                ...
                <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
                    ...
                    <tr>
                        <td class="text-right cname" width="81.5%"><b>{{ trans('message.Discount') }}
                                (<?php echo $dis = $discounts . '%'; ?>):</b></td>
                        <td class="text-center cname"><b><?php $dis = $discounts;
