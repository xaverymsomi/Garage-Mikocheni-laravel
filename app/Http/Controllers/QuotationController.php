	...
	public function store(Request $request)
{
    ...
    if ($discountPercentage) {
		...
		$services->insurer_name = $insurer;
		$services->broker_name = $broker;
		...
		$characters = '0123456789';
        $claim = 'CN' . substr(str_shuffle($characters), 0, 8);
        $services->claim_no = $claim;
	...
	public function quotationUpdate(Request $request, $id)
	{
		...
		$services->detail = $details;
		$services->insurer_name = $insurer_name;
		$services->broker_name = $broker_name;
		$services->service_type = $ser_type;
		$services->branch_id = $request->branch;
